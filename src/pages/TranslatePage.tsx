  ...
  const runTranslation = async () => {
    ...
    try {
      ...
      for (let start = 0; start < cues.length; start += batchSize) {
        ...
        easeProgressTo(Math.min(94, Math.max(8, ((start + batch.length * 0.88) / cues.length) * 100)));
