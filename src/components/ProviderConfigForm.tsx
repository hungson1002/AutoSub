...
function patchType(provider: AIProvider, nextType: ProviderType): AIProvider {
  ...
  return {
    ...
    baseUrl: nextType === 'groq' || nextType === 'elevenlabs' ? presetBaseUrl(nextType, provider.baseUrl) : provider.baseUrl,
    ...auth,
