...
function patchType(provider: AIProvider, nextType: ProviderType): AIProvider {
  ...
  return {
    ...
    baseUrl: nextType === 'groq' || nextType === 'elevenlabs' || nextType === 'hiiu-tts' || nextType === 'capcut-tts' ? presetBaseUrl(nextType, provider.baseUrl) : provider.baseUrl,
    ...auth,
