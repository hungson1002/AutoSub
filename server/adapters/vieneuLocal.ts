...
const VIENEU_PRESET_VOICES: Array<{ id: string; name: string; language: string; description: string }> = [
  { id: 'adam-bua', name: 'Adam bựa', language: 'vi-VN', description: 'Nam · Bắc · Tự nhiên, có màu sắc' },
  { id: 'truc-ly', name: 'Trúc Ly', language: 'vi-VN', description: 'Nữ · Bắc · Tự nhiên, ổn định' },
  { id: 'anh-khoi', name: 'Anh Khôi', language: 'vi-VN', description: 'Nam · Bắc · Kể chuyện' },
  { id: 'mai-anh', name: 'Mai Anh', language: 'vi-VN', description: 'Nữ · Bắc · Tin tức rõ ràng' },
  { id: 'minh-quan-pro', name: 'Minh Quân Pro', language: 'vi-VN', description: 'Nam · Bắc · Tự nhiên, ổn định' },
  { id: 'thuy-dung', name: 'Thùy Dung', language: 'vi-VN', description: 'Nữ · Nam · Tin tức rõ ràng' },
  { id: 'thien-tam-duc', name: 'Thiền Tâm Đức', language: 'vi-VN', description: 'Nam · Bắc · Kể chuyện' },
  { id: 'ngoc-huyen', name: 'Ngọc Huyền', language: 'vi-VN', description: 'Nữ · Bắc · Tự nhiên' },
  { id: 'quang-son', name: 'Quang Sơn', language: 'vi-VN', description: 'Nam · Trung · Tự nhiên' },
  { id: 'ngoc-tran', name: 'Ngọc Trân', language: 'vi-VN', description: 'Nữ · Trung · Tự nhiên' },
  ...
  { id: 'adam', name: 'Adam', language: 'vi-VN', description: 'Nam · Nam · Giọng đọc tự nhiên' },
  { id: 'manh-dung', name: 'Mạnh Dũng', language: 'vi-VN', description: 'Nam · Bắc · Tự nhiên' },
];
