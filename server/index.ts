...
import { manualFilmRoutes } from './routes/manualFilm';
import { animationStudioRoutes } from './routes/animationStudio';
import { storageRoutes } from './routes/storage';
import { mcpRoutes } from './routes/mcp';
import { ima2GptImageRoutes } from './routes/ima2GptImage';
...
await app.register(manualFilmRoutes);
await app.register(animationStudioRoutes);
await app.register(ima2GptImageRoutes);
